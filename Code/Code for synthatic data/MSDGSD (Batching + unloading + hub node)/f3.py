...
class DGSD:
    ...
    def spawn_server(self,workers,batches,server_index,q):
        ...
        self.start(server,workers,server_index)
...
def Generate_Embeddings( batch, nbins,ADDR):
    ...
    for v in batch:
        ...
        hub_nodes=receive_from_server([GET_HUB_NODE,v],client,communication_time_list)
        if(len(hub_nodes)<1):
            hist[0]=hist[0]+1
            continue
...
dgsd=DGSD()
bins = 20
name_dt=["ER1k.gxl","ER5k.gxl","ER10k.gxl","ER25k.gxl"]
_servers=[2]
